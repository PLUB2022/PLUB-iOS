...
extension MeetingService {
  ...
  func inquireCategoryMeeting(categoryID: String, page: Int, sort: String, request: CategoryMeetingRequest?) -> Observable<NetworkResult<GeneralResponse<CategoryMeetingResponse>>>  {
